...
var Shark = new (function(){
    ...
    this.setTrasnsform = function(){
      this.transformX= px-this.posx;//point of touch
      this.transformY= py-this.posy
    }
    this.draw = function ()
    {
...
// b_canvas.addEventListener("mousedown", doMouseMove, false);
//
...
// }
//
// b_canvas.addEventListener("click", doClick,false);
//
...
//        Shark.setTrasnsform();
// }
b_canvas.addEventListener("touchstart", touchStart, false);
